+++
title = 'HTTP 协议'
date = 2026-01-26T13:44:19+08:00
draft = false
author = "simons"
categories = ["计算机网络", "Web开发", "后端开发"]
tags = ["HTTP协议", "网络基础", "前端面试", "HTTPS", "HTTP/2", "TLS", "缓存机制", "跨域", "Cookie"]
description = "本文系统梳理了HTTP协议的核心知识体系，涵盖HTTP报文结构、请求方法、状态码、缓存机制、Cookie、HTTPS加密、HTTP/2优化等关键主题，通过深入解析和实际案例，帮助开发者建立完整的HTTP知识框架，从容应对面试和技术挑战。"
cover = "https://www.nginx.org.cn/uploads/article/20200919/20c7acc132f099a43d5cbe0a532cfef0.jpg"
+++

[查看原文](https://sanyuan0704.github.io/my_blog/http/001.htm)
...
## [#](https://sanyuan0704.github.io/my_blog/http/001.html#起始行)起始行
...
## [#](https://sanyuan0704.github.io/my_blog/http/001.html#头部)头部

展示一下请求头和响应头在报文中的位置:

[![img](https://sanyuan0704.github.io/my_blog/http/001.png)](https://sanyuan0704.github.io/my_blog/http/001.png)[![img](https://sanyuan0704.github.io/my_blog/http/002.png)](https://sanyuan0704.github.io/my_blog/http/002.png)
...
## [#](https://sanyuan0704.github.io/my_blog/http/001.html#空行)空行
...
## [#](https://sanyuan0704.github.io/my_blog/http/001.html#实体)实体

就是具体的数据了，也就是`body`部分。请求报文对应`请求体`, 响应报文对应`响应体`。

# 002. 如何理解 HTTP 的请求方法？

## [#](https://sanyuan0704.github.io/my_blog/http/002.html#有哪些请求方法？)有哪些请求方法？
...
## [#](https://sanyuan0704.github.io/my_blog/http/002.html#get-和-post-有什么区别？)GET 和 POST 有什么区别？
...
## [#](https://sanyuan0704.github.io/my_blog/http/003.html#uri-的结构)URI 的结构

URI 真正最完整的结构是这样的。

[![img](https://sanyuan0704.github.io/my_blog/http/004.png)](https://sanyuan0704.github.io/my_blog/http/004.png)
...
## [#](https://sanyuan0704.github.io/my_blog/http/003.html#uri-编码)URI 编码
...
## [#](https://sanyuan0704.github.io/my_blog/http/004.html#_1xx)1xx

**101 Switching Protocols**。在`HTTP`升级为`WebSocket`的时候，如果服务器同意变更，就会发送状态码 101。

## [#](https://sanyuan0704.github.io/my_blog/http/004.html#_2xx)2xx
...
## [#](https://sanyuan0704.github.io/my_blog/http/004.html#_3xx)3xx
...
**304 Not Modified**: 当协商缓存命中时会返回这个状态码。详见[浏览器缓存](https://sanyuan0704.github.io/my_blog/perform/001.html)

## [#](https://sanyuan0704.github.io/my_blog/http/004.html#_4xx)4xx
...
## [#](https://sanyuan0704.github.io/my_blog/http/004.html#_5xx)5xx
...
## [#](https://sanyuan0704.github.io/my_blog/http/005.html#http-特点)HTTP 特点
...
## [#](https://sanyuan0704.github.io/my_blog/http/005.html#http-缺点)HTTP 缺点

### [#](https://sanyuan0704.github.io/my_blog/http/005.html#无状态)无状态
...
### [#](https://sanyuan0704.github.io/my_blog/http/005.html#明文传输)明文传输

即协议里的报文(主要指的是头部)不使用二进制数据，而是文本形式。

这当然对于调试提供了便利，但同时也让 HTTP 的报文信息暴露给了外界，给攻击者也提供了便利。`WIFI陷阱`就是利用 HTTP 明文传输的缺点，诱导你连上热点，然后疯狂抓你所有的流量，从而拿到你的敏感信息。

### [#](https://sanyuan0704.github.io/my_blog/http/005.html#队头阻塞问题)队头阻塞问题
...
## [#](https://sanyuan0704.github.io/my_blog/http/006.html#数据格式)数据格式
...
## [#](https://sanyuan0704.github.io/my_blog/http/006.html#压缩方式)压缩方式
...
## [#](https://sanyuan0704.github.io/my_blog/http/006.html#支持语言)支持语言
...
## [#](https://sanyuan0704.github.io/my_blog/http/006.html#字符集)字符集
...
[![img](https://sanyuan0704.github.io/my_blog/http/005.png)](https://sanyuan0704.github.io/my_blog/http/005.png)

# 007: 对于定长和不定长的数据，HTTP 是怎么传输的？

## [#](https://sanyuan0704.github.io/my_blog/http/007.html#定长包体)定长包体
...
[![img](https://sanyuan0704.github.io/my_blog/http/004.jpg)](https://sanyuan0704.github.io/my_blog/http/004.jpg)

直接无法显示了。可以看到`Content-Length`对于 http 传输过程起到了十分关键的作用，如果设置不当可以直接导致传输失败。

## [#](https://sanyuan0704.github.io/my_blog/http/007.html#不定长包体)不定长包体
...
[![img](https://sanyuan0704.github.io/my_blog/http/001.gif)](https://sanyuan0704.github.io/my_blog/http/001.gif)

用 telnet 抓到的响应如下:

[![img](https://sanyuan0704.github.io/my_blog/http/005.jpg)](https://sanyuan0704.github.io/my_blog/http/005.jpg)
...
## [#](https://sanyuan0704.github.io/my_blog/http/008.html#如何支持)如何支持
...
## [#](https://sanyuan0704.github.io/my_blog/http/008.html#range-字段拆解)Range 字段拆解
...
## [#](https://sanyuan0704.github.io/my_blog/http/008.html#单段数据)单段数据
...
## [#](https://sanyuan0704.github.io/my_blog/http/008.html#多段数据)多段数据
...
## [#](https://sanyuan0704.github.io/my_blog/http/009.html#application-x-www-form-urlencoded)application/x-www-form-urlencoded
...
## [#](https://sanyuan0704.github.io/my_blog/http/009.html#multipart-form-data)multipart/form-data
...
## [#](https://sanyuan0704.github.io/my_blog/http/009.html#小结)小结
...
# 010: 如何解决 HTTP 的队头阻塞问题？

## [#](https://sanyuan0704.github.io/my_blog/http/010.html#什么是-http-队头阻塞？)什么是 HTTP 队头阻塞？

从前面的小节可以知道，HTTP 传输是基于`请求-应答`的模式进行的，报文必须是一发一收，但值得注意的是，里面的任务被放在一个任务队列中串行执行，一旦队首的请求处理太慢，就会阻塞后面请求的处理。这就是著名的`HTTP队头阻塞`问题。

## [#](https://sanyuan0704.github.io/my_blog/http/010.html#并发连接)并发连接

对于一个域名允许分配多个长连接，那么相当于增加了任务队列，不至于一个队伍的任务阻塞其它所有任务。在RFC2616规定过客户端最多并发 2 个连接，不过事实上在现在的浏览器标准中，这个上限要多很多，Chrome 中是 6 个。

但其实，即使是提高了并发连接，还是不能满足人们对性能的需求。

## [#](https://sanyuan0704.github.io/my_blog/http/010.html#域名分片)域名分片
...
## [#](https://sanyuan0704.github.io/my_blog/http/011.html#cookie-简介)Cookie 简介
...
## [#](https://sanyuan0704.github.io/my_blog/http/011.html#cookie-属性)Cookie 属性

### [#](https://sanyuan0704.github.io/my_blog/http/011.html#生存周期)生存周期
...
### [#](https://sanyuan0704.github.io/my_blog/http/011.html#作用域)作用域

关于作用域也有两个属性: **Domain**和**path**, 给 **Cookie** 绑定了域名和路径，在发送请求之前，发现域名或者路径和这两个属性不匹配，那么就不会带上 Cookie。值得注意的是，对于路径来说，`/`表示域名下的任意路径都允许使用 Cookie。

### [#](https://sanyuan0704.github.io/my_blog/http/011.html#安全相关)安全相关
...
## [#](https://sanyuan0704.github.io/my_blog/http/011.html#cookie-的缺点)Cookie 的缺点
...
## [#](https://sanyuan0704.github.io/my_blog/http/012.html#功能)功能
...
## [#](https://sanyuan0704.github.io/my_blog/http/012.html#相关头部字段)相关头部字段

### [#](https://sanyuan0704.github.io/my_blog/http/012.html#via)Via
...
### [#](https://sanyuan0704.github.io/my_blog/http/012.html#x-forwarded-for)X-Forwarded-For

字面意思就是`为谁转发`, 它记录的是**请求方**的`IP`地址(注意，和`Via`区分开，`X-Forwarded-For`记录的是请求方这一个IP)。

### [#](https://sanyuan0704.github.io/my_blog/http/012.html#x-real-ip)X-Real-IP

是一种获取用户真实 IP 的字段，不管中间经过多少代理，这个字段始终记录最初的客户端的IP。

相应的，还有`X-Forwarded-Host`和`X-Forwarded-Proto`，分别记录**客户端**(注意哦，不包括代理)的`域名`和`协议名`。

## [#](https://sanyuan0704.github.io/my_blog/http/012.html#x-forwarded-for产生的问题)X-Forwarded-For产生的问题
...
关于`强缓存`和`协商缓存`的内容，我已经在[能不能说一说浏览器缓存](https://sanyuan0704.github.io/my_blog/perform/001.html)做了详细分析，小结如下:
...
## [#](https://sanyuan0704.github.io/my_blog/http/013.html#为什么产生代理缓存？)为什么产生代理缓存？
...
## [#](https://sanyuan0704.github.io/my_blog/http/013.html#源服务器的缓存控制)源服务器的缓存控制

### [#](https://sanyuan0704.github.io/my_blog/http/013.html#private-和-public)private 和 public
...
### [#](https://sanyuan0704.github.io/my_blog/http/013.html#proxy-revalidate)proxy-revalidate

`must-revalidate`的意思是**客户端**缓存过期就去源服务器获取，而`proxy-revalidate`则表示**代理服务器**的缓存过期后到源服务器获取。

### [#](https://sanyuan0704.github.io/my_blog/http/013.html#s-maxage)s-maxage
...
## [#](https://sanyuan0704.github.io/my_blog/http/013.html#客户端的缓存控制)客户端的缓存控制

### [#](https://sanyuan0704.github.io/my_blog/http/013.html#max-stale-和-min-fresh)max-stale 和 min-fresh
...
### [#](https://sanyuan0704.github.io/my_blog/http/013.html#only-if-cached)only-if-cached
...
## [#](https://sanyuan0704.github.io/my_blog/http/014.html#什么是跨域)什么是跨域
...
首先要知道的是，浏览器是多进程的，以 Chrome 为例，进程组成如下：[![img](https://sanyuan0704.github.io/my_blog/http/007.jpg)](https://sanyuan0704.github.io/my_blog/http/007.jpg)[![img](https://sanyuan0704.github.io/my_blog/http/008.jpg)](https://sanyuan0704.github.io/my_blog/http/008.jpg)
...
[![img](https://sanyuan0704.github.io/my_blog/http/006.jpg)](https://sanyuan0704.github.io/my_blog/http/006.jpg)
...
## [#](https://sanyuan0704.github.io/my_blog/http/014.html#cors)CORS
...
### [#](https://sanyuan0704.github.io/my_blog/http/014.html#简单请求)简单请求
...
### [#](https://sanyuan0704.github.io/my_blog/http/014.html#非简单请求)非简单请求
...
## [#](https://sanyuan0704.github.io/my_blog/http/014.html#jsonp)JSONP
...
## [#](https://sanyuan0704.github.io/my_blog/http/014.html#nginx)Nginx

Nginx 是一种高性能的`反向代理`服务器，可以用来轻松解决跨域问题。

what？反向代理？我给你看一张图你就懂了。

[![img](https://sanyuan0704.github.io/my_blog/http/009.jpg)](https://sanyuan0704.github.io/my_blog/http/009.jpg)
...
## [#](https://sanyuan0704.github.io/my_blog/http/015.html#传统-rsa-握手)传统 RSA 握手

先来说说传统的 TLS 握手，也是大家在网上经常看到的。我之前也写过这样的文章，[(传统RSA版本)HTTPS为什么让数据传输更安全](https://sanyuan0704.github.io/my_blog/browser-security/003.html)，其中也介绍到了`对称加密`和`非对称加密`的概念，建议大家去读一读，不再赘述。之所以称它为 RSA 版本，是因为它在加解密`pre_random`的时候采用的是 RSA 算法。

## [#](https://sanyuan0704.github.io/my_blog/http/015.html#tls-1-2-握手过程)TLS 1.2 握手过程

现在我们来讲讲主流的 TLS 1.2 版本所采用的方式。

[![img](https://sanyuan0704.github.io/my_blog/http/010.jpg)](https://sanyuan0704.github.io/my_blog/http/010.jpg)

刚开始你可能会比较懵，先别着急，过一遍下面的流程再来看会豁然开朗。

### [#](https://sanyuan0704.github.io/my_blog/http/015.html#step-1-client-hello)step 1: Client Hello
...
### [#](https://sanyuan0704.github.io/my_blog/http/015.html#step-2-server-hello)step 2: Server Hello
...
### [#](https://sanyuan0704.github.io/my_blog/http/015.html#step-3-client-验证证书，生成secret)step 3: Client 验证证书，生成secret
...
### [#](https://sanyuan0704.github.io/my_blog/http/015.html#step4-server-生成-secret)step4: Server 生成 secret

刚刚客户端不是传了`client_params`过来了吗？

现在服务端开始用`ECDHE`算法生成`pre_random`，接着用和客户端同样的伪随机数函数生成最后的`secret`。

### [#](https://sanyuan0704.github.io/my_blog/http/015.html#注意事项)注意事项
...
### [#](https://sanyuan0704.github.io/my_blog/http/015.html#rsa-和-ecdhe-握手过程的区别)RSA 和 ECDHE 握手过程的区别
...
## [#](https://sanyuan0704.github.io/my_blog/http/016.html#强化安全)强化安全
...
## [#](https://sanyuan0704.github.io/my_blog/http/016.html#提升性能)提升性能

### [#](https://sanyuan0704.github.io/my_blog/http/016.html#握手改进)握手改进

流程如下:[![img](https://sanyuan0704.github.io/my_blog/http/011.jpg)](https://sanyuan0704.github.io/my_blog/http/011.jpg)
...
### [#](https://sanyuan0704.github.io/my_blog/http/016.html#会话复用)会话复用
...
### [#](https://sanyuan0704.github.io/my_blog/http/016.html#psk)PSK
...
## [#](https://sanyuan0704.github.io/my_blog/http/016.html#总结)总结
...
## [#](https://sanyuan0704.github.io/my_blog/http/017.html#头部压缩)头部压缩
...
- 首先是在服务器和客户端之间建立哈希表，将用到的字段存放在这张表中，那么在传输的时候对于之前出现过的值，只需要把**索引**(比如0，1，2，...)传给对方即可，对方拿到索引查表就行了。这种**传索引**的方式，可以说让请求头字段得到极大程度的精简和复用。![img](https://sanyuan0704.github.io/my_blog/http/009.png)
...
## [#](https://sanyuan0704.github.io/my_blog/http/017.html#多路复用)多路复用

### [#](https://sanyuan0704.github.io/my_blog/http/017.html#http-队头阻塞)HTTP 队头阻塞
...
### [#](https://sanyuan0704.github.io/my_blog/http/017.html#二进制分帧)二进制分帧
...
## [#](https://sanyuan0704.github.io/my_blog/http/017.html#服务器推送)服务器推送

另外值得一说的是 HTTP/2 的服务器推送(Server Push)。在 HTTP/2 当中，服务器已经不再是完全被动地接收请求，响应请求，它也能新建 stream 来给客户端发送消息，当 TCP 连接建立之后，比如浏览器请求一个 HTML 文件，服务器就可以在返回 HTML 的基础上，将 HTML 中引用到的其他资源文件一起返回给客户端，减少客户端的等待。

## [#](https://sanyuan0704.github.io/my_blog/http/017.html#总结)总结
...
[![img](https://sanyuan0704.github.io/my_blog/http/008.png)](https://sanyuan0704.github.io/my_blog/http/008.png)
