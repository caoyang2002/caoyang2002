...
author = "simons"
categories = ["心理学", "认知科学"]
tags = ["Kaufman实验", "视觉认知", "瞬时计数", "认知极限", "实验心理学", "认知负荷"]
description = "本文解析1949年Kaufman的经典实验：通过随机点阵呈现研究发现，人类视觉对1-5个物体的识别准确率超95%（瞬时计数），超过此数量则需意识计数且准确率下降。这项研究为认知极限、界面设计及Miller's Law提供了关键科学依据。"
+++
