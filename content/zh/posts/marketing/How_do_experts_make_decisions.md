...
draft = false
author = "simons"
categories = ["商业思维", "战略决策"]
tags = ["王慧文", "战略思维", "规模效应", "市场体量", "马太效应", "产业链", "先发优势", "商业判断", "清华产品课"]
description = "本文整理自王慧文清华产品课实录，系统阐述其核心商业决策框架。内容涵盖市场体量判断、规模效应曲线、马太效应、产业链分析、先发与后发时机、增量存量策略等十大维度，结合美团、外卖、社交网络等丰富案例，揭示高手如何在信息不完备下做出关键战略选择，避免常见认知陷阱。"
+++
