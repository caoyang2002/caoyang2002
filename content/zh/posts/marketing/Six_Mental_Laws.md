...
draft = false
author = "simons"
categories = ["营销策略", "消费者心理学"]
tags = ["心智规律", "行为经济学", "营销定位", "损失厌恶", "社交货币", "决策模型", "品牌战略"]
description = "本文深度解析六大心智规律（一限二求三法则），结合行为经济学经典理论（如有限理性、前景理论）与LV、微信付费阅读等案例，系统阐述如何利用大脑容量有限、追求安全与认同、效率优先等法则，设计有效的心智策略，让品牌精准触达并影响消费者决策。"
