...
draft = false
author = "simons"
categories = ["营销", "心理学", "经济学"]
tags = ["稀缺性", "价格歧视", "锚定效应", "行为经济学", "消费心理", "定价策略", "决策影响"]
description = "本文从马克·吐温笔下的汤姆·索亚刷墙故事出发，结合丹·艾瑞里的行为实验，深入探讨了‘稀缺性’与‘价格歧视’如何塑造消费决策。系统解析了锚定效应、一级/二级/三级价格歧视在商业中的实际应用（如星巴克、优衣库、电商平台等），揭示了‘难以获得’为何更具诱惑力，以及企业如何利用心理规律最大化利润与市场覆盖。"
