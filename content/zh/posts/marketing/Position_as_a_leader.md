...
draft = false
author = "simons"
categories = ["品牌战略", "定位理论", "商业案例"]
tags = ["定位理论", "领导者战略", "RCA", "IBM", "心智定位", "品类创新", "商业失败", "特劳特"]
description = "本文通过对比RCA与IBM在计算机领域的竞争，阐释了定位理论的核心：成为领导者的最佳方法是开创并主导一个新品类，而非直接挑战现有领导者。RCA的失败案例揭示了在顾客心智中建立独特位置的重要性，并引申出DEC通过开创'小型主机'品类获得成功的对比思考。"
