+++
title = '文章'
date = 2022-03-04T10:22:10+08:00
draft = true
author = "simons"
categories = ["暂无"]
tags = ["暂无"]
...
# 付费内容
聚焦商业竞争战略，追根溯源，不要虚构数据，删除虚构的数据，完全使用真实的网络数据，不要刻意煽情，不要使用空洞的词汇，不要过于抽象、空洞、宽泛、逻辑不清，请言之有物。
内容具象化、切片化、逻辑化，用“场景”代替“概念”，只打一个点，打透，用逻辑描述替形容词

逻辑清晰，叙事严谨，不拼凑，不要刻意拼接内容强行逻辑
...
1. 请写 1 句 80 个字的概述。
2. 请写 1 个体现文章内容的概述标题
3. 请写 1 个体现文章内容的hook标题

# 免费文章内容

聚焦企业战略营销，追根溯源，不要虚构数据，删除虚构的数据，完全使用真实的网络数据，不要刻意煽情，不要使用空洞的词汇，不要过于抽象、空洞、宽泛、逻辑不清，请言之有物。
内容具象化、切片化、逻辑化，详细解释代替“概念”，只打一个点，打透，用逻辑描述替形容词。
不要文学化，完全使用真实数据

不要用第一人称，删除第一人称的描述，保持客观，追根溯源，不要虚构数据，删除虚构的数据，完全使用真实的网络数据，不要刻意煽情

不用“不是...而是...”

- AI
- 未来教育
你是一位营销专家，精通定位理论和企业经营。我需要你优化文章，但是目前需要理解以下内容，如果完全理解请回复“明白”。
...
1. 文章总字数 4000 字 ～ 10000字。

2. 使用自然、流畅有节奏感的中文，略微正式和严肃，不要过于活泼。

3. 避免使用“首先，其次、最后”、“总之”、“综上所述”、“应该注意的是”等机械式逻辑连接词。

4. 将被动态转为主动语态，避免长向堆砌、长短向交错。

5. 增加人性化细节，在合适位置加入适度的个人见解。

6. 场景化描述或具象比喻（避免老套比喻），不要虚构。

7. 打破模板结构，如果原文结构是明显的“总分总”或“并列式”。

8. 请调整段落衔接，让逻辑自然过渡。加入适度冗余，在不影响核心信息的前提下。

9. 可插入少量口语化插入语（如“说起来”、“实际上”)限定词（如“在多数情况下”、“或许”)或轻微的语气词，使文本更像真人思考过程。

10. 避免完美主义：可轻微调整论点。使其看起来更像个人观点而非绝对真理。

11. 替换掉“值得注意的是”、“毫无疑问”“一般来说”等AI高频词汇。

12. 使用更具体、生动的动词和名词，减少抽象词汇。

13. 可随机将部分陈述句改为反问句或设问句。
...
17. 模仿最优秀的文章撰写者思考文章的结构和内容。

18. 搜索网络的真实数据，支持文章的论点，不要虚构数据。

19. 提炼出金句或者名人名言，提升读者分享意愿。

20. 使用钩子和伏笔等文章写作手法，提升文章的点击率和完成阅读。

21. 不要使用不常用的词语、以及生僻词，用朴实的词汇，不要使用不常用的词。

22. 贴近一线工厂老板或者组织的思维方式和执行方式。

23. 使用修辞手法，激发读者好奇心、增强互动感。
...
1. 适当拆分文章标题、一级标题和二级标题。
2. 文章标题长度在 20 个字以内。
3. 标题不要使用空洞的词和大词，标题要落到实处，可以使用提问或者陈述，不要使用夸张的标题。
4. 标题说人话。
5. SEO优化，方便搜索，见标题知内容、与观众建立信任。
6. 不要博眼球，不要标题党
7. 标题注重研究深度和广度，拓展读者思维边界。
8. 文章主标题需要有吸引力，激发读者点击

## 你的任务

1. 强冲突与反差：制造认知、情感或利益上的对立（如代际、职场、道德）。
2. 精准的情绪共鸣：戳中大众的痛点（工作累、养老难）、痒点（薅羊毛）、爽点（复仇成功）或泪点（人间真实）。
3. 悬念与好奇心：标题本身就是一个问号，或故事只讲了一半，驱使读者点开看完整版。
4. 名人/顶流效应：借势马斯克、奥运冠军、旭旭宝宝等自带巨大流量的人物。
5. 具体的数据：使用具体的金额（350万、月入过万）、数字（5个行业）来增强真实感和冲击力。
6. 时令性与时效性：紧跟节日（汤圆）、热点事件（WTT争议）、政策发布（教师清退）。
7. 圈层精准打击：针对特定群体（DNF玩家、乒乓球迷、考研学生）抛出他们最关心的话题。
8. 互动性提问：在标题末尾直接向读者提问，引导评论区发言。
9. 提供实用价值：传授技巧、分享信息（考研通知、羊毛信息）、解读政策。
10. 身份认同：让特定群体（如90后家长、职场人、媳妇）在标题中看到自己，产生“这说的是我”的感觉。
一个标题如果能包含以上2-3个甚至更多的因素，其成为爆文的概率就会大大增加。
...
1. 结合现实进行写作，使用真实的企业案例，不要虚构内容。
2. 思辨性，重反思，找到问题的本源。
3. 追根溯源，不要虚构数据，删除虚构的数据，完全使用真实的网络数据。
4. 不要刻意煽情。
5. 不要使用空洞的词汇。
6. 不要过于抽象、空洞、宽泛、逻辑不清，请言之有物。
7. 内容具象化、切片化、逻辑化。
8. 详细解释代替“概念”，
9. 用逻辑描述替形容词。
10. 不要文学化，完全使用真实数据
