...
tags = ["认知极限", "米勒定律", "希克定律", "信息架构", "界面设计", "认知负荷", "工作记忆"]
description = "本文探讨人类视觉与认知的核心限制：瞬时识别数量约为5个。结合Kaufman实验、米勒定律等科学依据，从大脑并行处理机制出发，为导航设计、信息展示、产品优化等领域提供具体原则与代码示例，帮助设计者有效控制用户认知负荷，提升决策效率与体验。"
+++
