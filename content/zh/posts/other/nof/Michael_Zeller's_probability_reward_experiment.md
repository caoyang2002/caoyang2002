...
draft = false
author = "simons"
categories = ["心理学", "行为科学", "经典实验"]
tags = ["迈克尔·泽勒", "概率奖励", "强化程序", "操作性条件反射", "动物决策", "行为经济学", "斯金纳", "对比分析"]
description = "本文深入解析行为心理学家迈克尔·泽勒（Michael Zeiler）的概率奖励选择实验：鸽子在确定奖励与50%-70%概率奖励之间，竟更偏好不可预测的选项。文章详细阐述了实验设计、核心发现及其对传统强化理论的挑战，并与斯金纳的迷信实验进行系统对比，揭示了不确定性本身如何驱动行为，为理解风险偏好、赌博机制及成瘾行为提供了关键实验依据。"
+++
