...
draft = false
author = "simons"
categories = ["品牌策略", "市场营销", "商业分析"]
tags = ["品类命名", "品牌定位", "艾·里斯", "分化理论", "命名原则", "消费心理学"]
description = "本文基于艾·里斯的品类思想，提出品类命名“八字诀”：有根、好感、直白、简称。通过猕猴桃（奇异果）、人造黄油、水蜜桃、计算机/电脑等案例，深入解析如何为新品类选择一个既符合认知规律又利于传播的好名字，避免陷入‘健康活力饮’这类模糊命名的误区。"
