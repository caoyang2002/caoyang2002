...
draft = false
categories = ["营销", "心理学", "用户体验"]
tags = ["决策瘫痪", "选择过载", "行为经济学", "消费者心理", "产品设计", "认知负荷"]
description = "本文深度解析“决策瘫痪”现象：当选择过多时，消费者反而难以做出决定甚至放弃购买。通过经典的果酱实验数据、神经科学原理及餐厅菜单、电商展示等实践案例，提供从信息架构、选项控制到界面设计的系统性解决方案，帮助商家在丰富性与易决策性之间找到最佳平衡点。"
toc = true
+++
